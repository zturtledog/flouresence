...
public class particle {
    ...
    public static void spawnparticle(ServerLevel world, Vec3 vec3, ParticleType particle) {
        world.sendParticles(ParticleTypes.FLAME, vec3.x(), vec3.y(), vec3.z(), 15, 0, 0, 0, 0);
    }
